...
from .transforms import GridMask
from .transforms_functional import block_scramble
from .hashid import hash_pil_image

__all__ = ['GeomScrambleGridImageFolder']

class GeomScrambleGridImageFolder(datasets.ImageFolder):
    def __init__(self, root, img_size=256, crop_size=224, grayscale=False,
                 ...
                 block_dim=8, linewidth=2, shuffle_seed=None, rotation_seed=None):
        """
        ...
        self.grid_mask = GridMask(self.block_dim, self.line_width, grid_color=[0, 0, 0], background_color=[1, 1, 1])
        ...
        self.transform_params = [
            dict(item_type='intact', transform='none', dx=0, dy=0, angle=0, scale=1.0, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='geometric', transform='translate', dx=-max_dx, dy=-max_dy, angle=0, scale=1.0, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='geometric', transform='translate', dx=-max_dx, dy=max_dy, angle=0, scale=1.0, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='geometric', transform='translate', dx=max_dx, dy=max_dy, angle=0, scale=1.0, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='geometric', transform='translate', dx=max_dx, dy=-max_dy, angle=0, scale=1.0, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='geometric', transform='rotate', dx=0, dy=0, angle=90, scale=1.0, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='geometric', transform='rotate', dx=0, dy=0, angle=180, scale=1.0, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='geometric', transform='rotate', dx=0, dy=0, angle=270, scale=1.0, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='geometric', transform='scale', dx=0, dy=0, angle=0, scale=0.9, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='geometric', transform='scale', dx=0, dy=0, angle=0, scale=1.2, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='geometric', transform='scale', dx=0, dy=0, angle=0, scale=1.4, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='geometric', transform='scale', dx=0, dy=0, angle=0, scale=1.6, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='geometric', transform='scale', dx=0, dy=0, angle=0, scale=1.8, block_dim=block_dim, shuffle=False, rotate=False),
            dict(item_type='scramble', transform='scramble', dx=0, dy=0, angle=0, scale=1.0, block_dim=block_dim, shuffle=shuffle, rotate=rotate),
        ]
